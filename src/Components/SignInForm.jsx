...
const SignupForm = (props) => {
  ...
  return (
    <div className="bg-white text-black  rounded-lg p-20 relative">
      ...
      <button onClick={signInHandler} className="bg-dark text-white w-full py-2 rounded-full border-black border-2 hover:bg-white hover:text-black transition-all duration-200">
        Sign In
      </button>
